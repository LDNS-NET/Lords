                            ...
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    <div v-if="form.errors.id_number" class="mt-1 text-sm text-red-600">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    <div v-if="form.errors.house_number" class="mt-1 text-sm text-red-600">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    <div v-if="form.errors.move_in_date" class="mt-1 text-sm text-red-600">
                                        {{ form.errors.move_in_date }}
                                    </div>
                                </div>
                            </div>
