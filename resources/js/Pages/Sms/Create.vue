                        ...
                        <form @submit.prevent="submit">
                            <div class="mb-4">
                                <div class="flex items-center justify-between mb-2">
                                    <label class="block text-sm font-medium dark:text-gray-300 text-gray-700">Recipients</label>
                            ...
                            <div class="mb-4 text-gray-700">
                                ...
                                <div class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ form.message.length }} / 500 characters</div>
                                <div v-if="form.errors.message" class="mt-1 text-sm text-red-600">{{ form.errors.message }}</div>
                            </div>

                            <div class="flex justify-end space-x-3">
                                <a :href="route('sms.index')" class="px-4 py-2 text-gray-700 dark:text-gray-300 bg-gray-200 dark:bg-gray-600 rounded-md hover:bg-gray-300 dark:hover:bg-gray-700">
                                    Cancel
                                </a>
