...
const submit = () => {
    ...
    form.post(route('emails.store'), {
        ...
        onError: () => {
            toast.error('Failed to send email. Please check the form for errors.');
        },
    });
};
</script>
                    ...
                    <div class="p-6">
                        <form @submit.prevent="submit">
                            ...
                            <div class="mb-4">
                                <div class="flex items-center justify-between mb-2">
                                    ...
                                    <label class="flex items-center">
                                        <input
                                            ...
                                            class="mr-2 border-gray-300 dark:border-gray-600 dark:bg-gray-700 rounded focus:ring-blue-500"
                                        />
                                ...
                                <div
                                    class="p-4 space-y-2 border border-gray-300 dark:border-gray-700 rounded-md max-h-64 overflow-y-auto bg-gray-50 dark:bg-gray-900"
                                >
                                    <label
                                    ...
                                    <div v-if="renters.length === 0" class="text-sm text-gray-500 dark:text-gray-400">
                                        No renters available. Please add renters first.
                                    </div>
                                </div>

                                <div v-if="form.errors.recipients" class="mt-1 text-sm text-red-600">
                            ...
                            <div class="mb-4">
                                ...
                                <input
                                    ...
                                    class="block w-full mt-1 border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            ...
                            <div class="flex justify-end space-x-3">
                                ...
                                <button
                                    ...
                                    class="px-4 py-2 text-white bg-blue-600 rounded-md hover:bg-blue-700 disabled:opacity-50 transition"
                                >
                                    Send Email
                                </button>
                            </div>
