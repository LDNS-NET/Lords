            ...
            <form @submit.prevent="submit">
              ...
              <div class="mb-4">
                ...
                <select
                  ...
                  class="block w-full mt-1 border-gray-300 dark:border-gray-700
                ...
                <div
                  v-if="form.errors.renter_id"
                  class="mt-1 text-sm text-red-600 dark:text-red-400"
                >
                  {{ form.errors.renter_id }}
                </div>
              </div>
              ...
              <div class="mb-4">
                ...
                <div class="relative mt-1">
                  ...
                  <input
                    ...
                    step="0.01"
                    min="0"
                    class="block w-full pl-7 border-gray-300 dark:border-gray-700
                           rounded-md shadow-sm
                           focus:border-blue-500 focus:ring-blue-500
                           text-sm font-medium
                           text-gray-700 dark:text-gray-200
              ...
              >
                <p class="text-sm">
                  <strong>Note:</strong>
                  This will create a payment record. The renter can then pay via
                  Paystack using the generated reference.
                </p>
              </div>
              ...
              <div class="flex justify-end space-x-3">
                <a
                  ...
                  class="px-4 py-2
                         text-gray-700 bg-gray-200 rounded-md hover:bg-gray-300
