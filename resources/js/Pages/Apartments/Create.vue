                    ...
                    <div class="p-6">
                        <form @submit.prevent="submit">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" id="number_of_units" v-model="form.number_of_units" 
                                    class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                            ...
                            <div class="flex justify-end space-x-3">
                                <a :href="route('apartments.index')" class="px-4 py-2 text-gray-700 bg-gray-200 rounded-md hover:bg-gray-300">
                                    Cancel
                                </a>
