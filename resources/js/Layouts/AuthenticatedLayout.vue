...
<template>
  <!-- Wrapper -->
  <div
    class="flex min-h-screen bg-gray-50 text-gray-900 dark:bg-gray-900 dark:text-white transition-colors duration-300">
    <!-- Sidebar -->
    <aside
      ...
      <div class="flex items-center justify-between px-4 py-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <button @click="sidebarOpen = false" class="lg:hidden text-gray-500 hover:text-gray-700 dark:text-gray-300">
      ...
      <nav class="p-4 space-y-1 overflow-y-auto h-[calc(100vh-4rem)]">
        ...
        <div class="mb-4 px-3">
          <NavLink :href="route('dashboard')" :active="route().current('dashboard')" class="flex items-center p-2">
        ...
        <div class="mb-4 px-3">
          <NavLink :href="route('apartments.index')" :active="route().current('apartments.index')"
        ...
        <div class="mb-4 px-3">
          <NavLink :href="route('renters.index')" :active="route().current('renters.index')"
            class="flex items-center p-2">
        ...
        <div class="mb-4 px-3">
          <NavLink :href="route('sms.index')" :active="route().current('sms.index')" class="flex items-center p-2">
    ...
    <!-- Overlay (mobile) -->
    <div v-if="sidebarOpen" @click="sidebarOpen = false" class="fixed inset-0 bg-black opacity-50 z-20 lg:hidden"></div>
    ...
    <div class="flex flex-col flex-1 min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      ...
      <nav
        ...
        <div class="flex gap-4 font-extrabold items-left ml-2">
          <button @click="sidebarOpen = true" class="lg:hidden text-gray-600 dark:text-gray-300 focus:outline-none">
            <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex ml-2">
          <Dropdown align="right" width="48">
            ...
            <template #content>
              <DropdownLink @click="theme = theme === 'dark' ? 'light' : 'dark'"
      ...
      <header v-if="$slots.header" class="bg-white dark:bg-gray-800 shadow transition-colors duration-300">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 text-gray-900 dark:text-white">
          <slot name="header" />
        </div>
      </header>

      <!-- Main Content -->
      <main class="flex-1 p-4 bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
        <slot />
      </main>
    </div>
  </div>
